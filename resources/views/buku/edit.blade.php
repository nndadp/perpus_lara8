...
<body>
    ...
    <div class="container">
        ...
        <div class="container-input">
            <form action="{{ route('buku.update',$model->id) }}" method="POST">
            @csrf
            @method('PUT')
            <tr>
                <label>Judul Buku :</label>
                <input type="text" name="judul_buku" class="input" value="{{ $model->judul_buku }}">
            </tr>
            <tr>
                <label>Penerbit :</label>
                <input type="text" name="penerbit" class="input" value="{{ $model->penerbit }}">
            </tr>
            <tr>
                <label>Pengarang :</label>
                <input type="text" name="pengarang" class="input" value="{{ $model->pengarang }}">
            </tr>
        <br><br>
            <tr>
