...
<body>
    ...
    <div class="container">
        ...
        <form action="{{ route('rayon.update',$model->id) }}" method="POST">
            @csrf
            @method('PUT')
            <tr>
                <label>Rayon :</label>
                <input type="text" name="rayon" class="input" value="{{ $model->rayon }}">
            </tr>
            <tr>
                <label>Pembingbing :</label>
                <input type="text" name="pembingbing" class="input" value="{{ $model->pembingbing }}">
            </tr>
            <tr>
                <label>No Telpon :</label>
                <input type="text" name="no_telp" class="input" value="{{ $model->no_telp }}">
            </tr>
        <br><br>
            <tr>
